...
def connect():
	...
	cursor = conn.cursor()
	print("connect")
	sql_query = "CREATE TABLE dcfvunds3mi9ke.user_info (Gender VARCHAR(45) NOT NULL,Age VARCHAR(45) NULL,Country VARCHAR(45) NULL,FavTeam VARCHAR(45) NULL,TimeEntered VARCHAR(45) NULL;"
