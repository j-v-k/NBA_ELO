...
class User_Info(Resource):
    ...
    def post(self):
        ...
        qstring =  "INSERT INTO user_choice ("
...
class Players_Respone(Resource):
    ...
    def post(self):
        ...
        query = cnxn.execute("INSERT INTO player_choice (User_ID, Player_1, Player_2, Player_Choice, TimeEntered) VALUES ('%s','%s','%s','%s', '%s')" % (str(User_ID), Player_1,Player_2, Player_Choice, TimeEntered)) # This line performs query and returns json result
        print("Choice Sent")
